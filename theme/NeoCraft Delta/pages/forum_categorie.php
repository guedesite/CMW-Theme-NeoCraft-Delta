<?php if(!isset($_GET['id'])) header('Location: ?page=erreur&erreur=16');
	...
	if(!(($_Joueur_['rang'] == 1 AND !$_SESSION['mode']) OR $_PGrades_['PermsDefault']['forum']['perms'] >= $categoried['perms'] OR $categoried['perms'] == 0)) header('Location: ?page=erreur&erreur=7');?>
		...
		<div class="neo-background-haut neo-padding-16 container">
		<div class="neo-content-headline">
			<div class="neo-line-headline" style="width: 100%"><h2><em><strong><span style="font-size:40px">Forum: <?=$categoried['nom'];?></span></strong></em></h2></div>
		</div>
			...
			?>
			<div class="neo-radius neo-center" style="padding:15px;">
		...
		{
		?>
		<div class="neo-background-millieu neo-padding-16 container" style="margin-top:20px;">
		...
		<div class="neo-background-millieu neo-padding-16 container" style="margin-top:20px;">
		<?php if(($_Joueur_['rang'] == 1 OR $_PGrades_['PermsForum']['general']['addSousForum'] == true) AND !$_SESSION['mode'] && !isset($id_sous_forum))
		{
			?>
	...
	{
		?>
		<div class="neo-background-bas neo-padding-16 container" style="margin-top:20px;">
