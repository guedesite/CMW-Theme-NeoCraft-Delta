...
if(isset($_GET['id']))
{
	...
	<div class="neo-background-haut container" style="padding:15px;">	
	<div class="neo-content-headline">
		<div class="neo-line-headline" style="width: 100%"><h2><em><strong><span style="font-size:40px">Post: <?=$topicd['nom'];?></span></strong></em></h2></div>
	</div>
	...
	<div class="neo-background-millieu container" style="padding:15px; margin-top:20px;">	
	...
	<div class="neo-background-bas container" style="padding:15px; margin-top:20px;">	<?php 
